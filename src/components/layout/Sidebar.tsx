      ...
      <div className="border-t border-gray-100 dark:border-gray-800">
        ...
        {!collapsed ? (
          <div className="px-4 py-2.5 border-b border-gray-100 dark:border-gray-800">
            <label className="text-[10px] text-gray-400 dark:text-gray-500 block mb-1">目前角色</label>
            <select
              value={currentRole}
              onChange={(e) => setCurrentRole(e.target.value as Role)}
              className="w-full text-xs px-2 py-1.5 border border-gray-200 dark:border-gray-700 rounded bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-400"
            >
          ...
          <div className="flex justify-center py-2.5 border-b border-gray-100 dark:border-gray-800" title={`角色: ${ROLE_LABELS[currentRole]}`}>
            <span className="text-[10px] font-medium text-gray-500 dark:text-gray-400">{ROLE_LABELS[currentRole]}</span>
          </div>
        )}
        {!collapsed && (
